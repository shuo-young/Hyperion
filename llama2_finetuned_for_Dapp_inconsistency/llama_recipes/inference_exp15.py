...
def inference(user_input,context):
    ...
    # 计算所有样本的 token 数量
    token_count = sum(batch['attention_mask'].sum(dim=1)).item()
    print(f"Token数量为: {token_count}\n")
    # print(f"总的context为:{context}\n")
...
def main():
    ...
    text_file = "/home/zhongqy/workplace/llama2_finetuning_for_Dapp/experiments/16/all_case_1000.json"
    
    # 输出文件路径
    # out_file_path = "/GPUFS/nsccgz_ywang_zfd/zhongqy/llama2_finetuning_for_Dapp/experiments/6/out3.json"
    out_file_path = "/home/zhongqy/workplace/llama2_finetuning_for_Dapp/experiments/16/18_19_case_out.json"
    
    # 日志文件==========================================================
    # log_file = "/GPUFS/nsccgz_ywang_zfd/zhongqy/llama2_finetuning_for_Dapp/experiments/6/exp.log"
    log_file = "/home/zhongqy/workplace/llama2_finetuning_for_Dapp/experiments/16/18_19_log.out"
...
If a question does not make any sense, or is not factually coherent, explain why instead of answering something not correct. If you don't know the answer to a question, please don't share false information.
            ...
            prompt1 = q1+"\nFollowing this sentence, all content is the text i provided:"+input_text
