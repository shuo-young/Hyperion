...
def main(
    ...
    temperature: float=0.75, # [optional] The value used to modulate the next token probabilities.调整输出的随机性，大于1是随机的，大于0是确定的，0.75是一个好的起始值。
    ...
    **kwargs
    ...
    model.resize_token_embeddings(new_num_tokens, pad_to_multiple_of=8)
