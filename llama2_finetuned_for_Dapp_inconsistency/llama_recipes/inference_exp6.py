...
def main():
    ...
    note = "第6次测试，基于实验3-1，扩充case到20个,预训练+微调的lora"
    print("开始自动化测试......")
    print(note)
    i=1
    ...
    out_file_path = "/home/zhongqy/workplace/llama2_finetuning_for_Dapp/experiments/6/out_3000pre_84ft.json"
    
    # 日志文件==========================================================
    # log_file = "/GPUFS/nsccgz_ywang_zfd/zhongqy/llama2_finetuning_for_Dapp/experiments/6/exp.log"
    log_file = "/home/zhongqy/workplace/llama2_finetuning_for_Dapp/experiments/6/log_3000pre_84ft.out"
