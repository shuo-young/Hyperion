...
# 从所有样本中选出在测试集样本
train_samples = [sample for sample in all_samples if str(sample['id']) in [test_sample['id'] for test_sample in test_samples]]
print(f'最终的test case数：{len(train_samples)}')

# 保存
with open('out_test_case_3000.json', 'w') as ft_alpaca_data:
